                            ...
                            <div class="container">
                                ...
                                <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="bargraph.php">Bar Graph</a>
                                        </li>
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Options</a>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="editemails.php">Edit Emails</a>
                                                <a class="dropdown-item" href="editsites.php">Edit Sites</a>
