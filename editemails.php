            ...
            <div class="row">
                    <div class="col-12">
                      <div class="page-header-title">
                        <h2 class="heading-title text-center">You can Edit your Mails from Here</h2>
                      </div>
                      <!-- Standard Button -->
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12">
                                <div id="contact-form-1">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="mail" placeholder="example@abc.com" name="mail" size="30" required>
...
function addMail($data)
{
    ...
    $qry=mysqli_query($GLOBALS['db'],"select * from mails where id='$id' and mail='$mail'");

    if($qry->num_rows >0)
    {
        echo "<script>alert('Mail is already added.')</script>";
    }
    else
    {
        $insert_qry = "insert into mails values ('$id', '$mail')";
...
function deleteMail($data)
{
    ...
    $delete_qry = "delete from mails where id='$id' and mail='$mail'";
...
function onLoad()
{
    ...
    $qry=mysqli_query($GLOBALS['db'],"select * from mails where id='$id'");
        ...
        echo "
            <div class='table-responsive mtb'>
                  <table class='table table-hover'>
                    ...
                    <tbody>
                    <tr>
                        <th scope='row' colspan=2><center>No Mails Added</center></th>
                      </tr>
                      </tbody>
                      </table>
                </div>";
